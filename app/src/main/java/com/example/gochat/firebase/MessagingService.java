package com.example.gochat.firebase;
...
import com.example.gochat.activities.ChatActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        builder.setContentText(Constants.decodeString(remoteMessage.getData().get(Constants.KEY_MESSAGE)));
